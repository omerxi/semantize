<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="data[label[text()='Dénomination']][1]">
    <rdf:Description rdf:about="http://omerxi.com/resource/driver_corporation_{$ordinal}">
      <foaf:name>
        <xsl:value-of select="./value"/>
      </foaf:name>
  ...
  <xsl:template match="data[label[text()='Numéro SIRET']]">
    <rdf:Description rdf:about="http://omerxi.com/resource/driver_corporation_{$ordinal}">
      <cob:siren>
        <xsl:value-of select="./value"/>
      </cob:siren>
  ...
  <xsl:template match="data[label[text()='Représentants légaux/statutaires']]/value/data[1]">
    <rdf:Description rdf:about="http://omerxi.com/resource/driver_corporation_{$ordinal}">
      <oxi:manager>
        <xsl:value-of select="./value"/>
      </oxi:manager>
